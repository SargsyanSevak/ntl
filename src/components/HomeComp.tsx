  ...
  return (
    <div className="bg-white min-h-screen flex flex-col lg:flex-row justify-center items-center">
      <div className="relative isolate px-6  lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-50 sm:left-[calc(50%-20rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
