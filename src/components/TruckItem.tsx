  ...
  return (
    <>
      ...
      <div
        ...
        className="mobile lg:hidden flex bg-slate-200 dark:bg-[#0E192D] dark:text-slate-200  border-b-4 border-stone-50 sm:px-4 px-4 pb-8 text-[0.9rem] md:text-[1.2rem] font-bold relative"
