        ...
        <>
          ...
          <div className="relative mt-2 w-full">
            <Listbox.Button
              ...
              } relative  cursor-default rounded-md ${adminVersion ? 'lg:py-2 py-[10px]' : 'py-[6px]'} pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-[#1C90F3] sm:text-sm sm:leading-6 w-full`}
